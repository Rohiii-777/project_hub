...
export default async function LoginPage() {
  // Check if an admin user exists. If not, redirect to register.
    ...
    <main className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 bg-[#07080e] relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10 flex flex-col gap-6">
        ...
        <div className="text-center">
          <div className="inline-flex p-3 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 mb-4 shadow-inner shadow-indigo-500/5">
            <Layers size={28} />
          </div>
          ...
          <p className="text-sm text-slate-400 mt-2 font-medium">
            Log in to monitor and launch your applications.
          </p>
        </div>
